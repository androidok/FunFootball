...
public class UpdateUtils {
    ...
    public interface OnDownloadCompleteListener {
        void onDownloadComplete(Uri loadedFileUri);
    }
     ...
     * @param context
     * @param listener
     * @return 返回注册后的receiver，可以在适当时候unregist
     */
    public static BroadcastReceiver registCompleteListener(
            Context context, final OnDownloadCompleteListener listener) {
     ...
     * @return null-获取不到
     */
    private static Uri getDownloadUriById(Context context, long enqueueId) {
        DownloadManager.Query query = new DownloadManager.Query();
