...
import com.qysports.funfootball.activity.MatchDetailActivity;
...
public class MatchPrivateAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MatchPrivateAdapter(Context context, List<Match> datas) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_VIEW_TYPE_HEADER) {
            ...
            View v = LayoutInflater.from(context).inflate(R.layout.item_match_private, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (itemViewType == ITEM_VIEW_TYPE_HEADER) {
            ...
            final Match data = datas.get(position - 1);
